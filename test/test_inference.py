...
# Add project root to sys.path so we can import 2md modules directly
...
def test_readerlm_html_to_markdown():
    ...
    from web2md import load_reader_model, html_to_markdown
...
def test_readerlm_full_html2md_pipeline():
    ...
    from html2md import process_html_file
    from web2md import load_reader_model
    from md_common import OutputFormat  # OutputFormat.md is the enum value
...
def test_vlm_image_ocr():
    ...
    """
    from img2md import load_vlm_model, image_to_markdown_text, get_image_metadata
...
def test_vlm_pdf_scanned_page_ocr():
    ...
    """
    from pdf2md import render_page_as_image, extract_page_via_vlm, load_vlm_for_pdf
...
def test_parakeet_transcription():
    ...
    from yt2md import transcribe, convert_audio_for_whisper, resolve_model
