...
# Import functions from yt2md.py
try:
    from yt2md import (
        extract_video_id,
        segments_to_srt,
    ...
    print(f"Error importing from yt2md.py: {e}")
    print("Make sure yt2md.py is in the same directory and all dependencies are installed.")
    print("Required packages: yt-dlp, mlx-audio")
    sys.exit(1)
